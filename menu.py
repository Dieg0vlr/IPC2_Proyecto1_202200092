...
#-------------------------------- Crear doc XML ----------------------------------------
 ...
 #----------------------------------------------------------------------------------------------              
    ...
    def mostrar_estudiante(self):
        ...
        print("Seccion: B")
        print("4to. Semestre")
        print("ACA VA EL ENLAcE A MI DOCUMENTACION")
